	...
	class Details {
		constructor() {
			this.DOM = {};
				...
				const detailsTmpl = `
			<<nav>div class="details__bg details__bg--down">
			<nav class="navbar navbar-expand-lg navbar-light nav-distance">
                                                        <a class="navbar-brand" href="#">Eyebe</a>
                                                        <button>
<button class="details__close"> 
														<i class="fas fa-2x fa-times icon--cross tm-fa-close">
...
::before
		...
		open(data) {
			...
			}px) translateY(${rect.productBgRect.top - rect.detailsBgRect.top}px) scaleX(${
